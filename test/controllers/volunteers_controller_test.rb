...
class VolunteersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create volunteer" do
    assert_difference("Volunteer.count") do
      post volunteers_url, params: { volunteer: { job_id: @volunteer.job_id, volunteer_id: @volunteer.volunteer_id } }
    end
  ...
  test "should update volunteer" do
    patch volunteer_url(@volunteer), params: { volunteer: { job_id: @volunteer.job_id, volunteer_id: @volunteer.volunteer_id } }
